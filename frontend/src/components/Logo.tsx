      ...
      <svg className="logo-bot" viewBox="0 0 80 88" fill="none">
        <defs>
          <linearGradient id={body} x1="20" y1="18" x2="62" y2="78" gradientUnits="userSpaceOnUse">
            <stop stopColor="#dacebe" />
            <stop offset=".45" stopColor="#db8f2a" />
            <stop offset="1" stopColor="#141414" />
          </linearGradient>
          <linearGradient id={face} x1="28" y1="14" x2="54" y2="38" gradientUnits="userSpaceOnUse">
            <stop stopColor="#ffffff" />
            <stop offset="1" stopColor="#dacebe" />
          </linearGradient>
        </defs>
        <ellipse className="bot-shadow" cx="40" cy="82" rx="16" ry="3.2" fill="#141414" opacity=".16" />
        <g className="bot-leap">
          <path d="M40 8v7" stroke="#141414" strokeWidth="2.4" strokeLinecap="round" />
          <circle cx="40" cy="6.5" r="3.2" fill="#db8f2a" />
          ...
          <rect x="31" y="54" width="18" height="8" rx="4" fill="#141414" opacity=".16" />
          <rect x="24" y="16" width="32" height="30" rx="12" fill={`url(#${face})`} />
          <rect x="27" y="20" width="26" height="18" rx="8" fill="#141414" />
          <circle cx="35" cy="29" r="3.1" fill="#db8f2a" />
          <circle cx="45" cy="29" r="3.1" fill="#db8f2a" />
          <circle cx="34.2" cy="28.2" r="1.1" fill="#fff" />
          <circle cx="44.2" cy="28.2" r="1.1" fill="#fff" />
          <path d="M35 35.5c1.6 2.2 8.4 2.2 10 0" stroke="#db8f2a" strokeWidth="2.2" strokeLinecap="round" />
          <circle cx="30.5" cy="34.5" r="2.1" fill="#e8c48a" />
          <circle cx="49.5" cy="34.5" r="2.1" fill="#e8c48a" />
